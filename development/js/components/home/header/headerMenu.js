...
export const HeaderMenu = () => {
    ...
    return (<>
            ...
            <ul className="col-12 header__content__menu">
                <Link className="header__content__menu__link " to="signInLog" smooth ={true} duration={1000} >Start</Link>
                <Link className="header__content__menu__link " to = "simpleSteps" smooth ={true} duration={1000}>O co chodzi?</Link>
