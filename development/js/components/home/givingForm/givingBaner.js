...
export const Banner = ({showStep}) => {
    ...
    return (<>
            <div className=" givingBanner ">
                ...
                {(showStep === 1) &&
                <p className="row givingBanner__text"> Uzupełnij szczegóły dotyczące Twoich rzeczy. Dzięki temu będziemy
                ...
                {(showStep === 3) &&
                <p className="row givingBanner__text">Jeśli wiesz komu chcesz pomóc, możesz wpisać nazwę tej organizacji
                    w wyszukiwarce. Możesz też filtrować organizacje po ich lokalizacji bądź celu ich pomocy. </p>}
                {(showStep === 4) && <p className="row givingBanner__text">Podaj adres oraz termin odbioru rzeczy. </p>}
            </div>
