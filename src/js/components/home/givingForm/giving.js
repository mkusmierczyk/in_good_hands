...
import FormHeroImage from "../../../../images/assets/Form-Hero-Image.jpg";
import BackgroundForm from "../../../../images/assets/Background-Form.jpg";
    ...
    return (<>
            <div className="container">
                <div className="row giving ">
                    <div className="col-6 giving__pic" style={style}></div>
                    <div className="col-6 giving__content">
                        <HeaderSignInLog/>
                        <HeaderMenu/>
                        <GivingMainContent decoration={decoration}/>
                    </div>
                </div>
